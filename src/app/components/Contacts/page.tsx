...
export default function Contacts() {
  return (
    <div id="contacts">
      <section className="relative h-[85vh] bg-black text-white flex items-center justify-center px-6">
        ...
        <div className="relative w-full max-w-6xl grid md:grid-cols-2 gap-16 z-10">
          <motion.div
          ...
          >
            ...
            <form className="space-y-6">
              ...
              <motion.div whileFocus={{ scale: 1.02 }}>
                <Textarea placeholder="Your Message" rows={5} className="w-full px-4 py-3 rounded-lg bg-neutral-900 border border-neutral-700 focus:outline-none focus:border-white" />
              </motion.div>
              <Button
                asChild
          ...
          >
            ...
            <div className="space-y-2">
              <p className="text-lg flex items-center gap-2">
                <Mail size={20} className="text-white" /> texnop30618@gmail.com
              </p>
              <p className="text-lg flex items-center gap-2">
                <Phone size={20} className="text-white" /> +7 (747) 7356316
              </p>
              <p className="text-lg flex items-center gap-2">
                <MapPin size={20} className="text-white" /> Astana, Kazakhstan
              </p>
            </div>
            <div className="flex space-x-4">
              <motion.a
                href="https://t.me/zixxxos"
                whileHover={{ scale: 1.2 }}
                className="w-10 h-10 flex items-center justify-center rounded-full bg-neutral-900 border border-neutral-700"
              >
              ...
              <motion.a
                href="https://hh.kz/resume/34e64f22ff0f484b010039ed1f70756f536d49"
                whileHover={{ scale: 1.2 }}
                className="w-10 h-10 flex items-center justify-center rounded-full bg-neutral-900 border border-neutral-700"
              >
                <Button variant="ghost" size="icon">
                  <Heading width={20} height={20} className="hover:cursor-pointer" />
                </Button>
              </motion.a>
              <motion.a
                href="https://github.com/Jasulan273"
                whileHover={{ scale: 1.2 }}
                className="w-10 h-10 flex items-center justify-center rounded-full bg-neutral-900 border border-neutral-700"
              >
                <Button variant="ghost" size="icon" className="hover:cursor-pointer">
