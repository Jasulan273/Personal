...
export default function Experience() {
  return (
    <div className="relative bg-white min-h-screen flex flex-col items-center justify-center overflow-hidden px-4 sm:px-6 py-12">
      <motion.h2
      ...
      <div className="w-full max-w-[900px] h-[70vh] sm:h-[75vh] lg:h-[80vh] rounded-xl border border-gray-200 bg-white shadow-xl overflow-hidden">
